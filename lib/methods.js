Meteor.methods({
  ...
  addBallotResults: function (ballotData) {
    ...
    // Since this finalizes the ballot, we will put the final choices in a final array
    ballotData.choicesFinal = ballotData.choicesCurr;
    ...
    for (var i = voteBallots.length - 1; i >= 0; i--) {
      ...
      var choicesArray = voteBallots[i].choicesFinal;
