...
Router.map(function (){
  ...
  this.route("/voteInfo", {
    ...
    waitOn: function(){
      // waitOn makes sure that this publication is ready before rendering your template
      return Meteor.subscribe("votesList") && Meteor.subscribe("voteOptions") && Meteor.subscribe("voteResults");
    },
    data: {
      navAction: [
  ...
  this.route("/voteOptionEdit", {
    path: "/voteOptionEdit/:_id",
    template: "voteOption",
    data: {
      edit: true
    }
  ...
  this.route("/doVote", {
    ...
    waitOn: function(){
      // waitOn makes sure that this publication is ready before rendering your template
      return Meteor.subscribe("voteResults");
    }
  });

  this.route("/voteConfirm");
